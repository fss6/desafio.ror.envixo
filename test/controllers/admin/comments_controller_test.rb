...
class Admin::CommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_comment" do
    assert_difference('Admin::Comment.count') do
      post admin_comments_url, params: { admin_comment: { commentable_id: @admin_comment.commentable_id, commentable_type: @admin_comment.commentable_type, content: @admin_comment.content, locale: @admin_comment.locale, user_id: @admin_comment.user_id, verified: @admin_comment.verified } }
    end
  ...
  test "should update admin_comment" do
    patch admin_comment_url(@admin_comment), params: { admin_comment: { commentable_id: @admin_comment.commentable_id, commentable_type: @admin_comment.commentable_type, content: @admin_comment.content, locale: @admin_comment.locale, user_id: @admin_comment.user_id, verified: @admin_comment.verified } }
