...
class Admin::NewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_news" do
    assert_difference('Admin::News.count') do
      post admin_news_index_url, params: { admin_news: { content: @admin_news.content, subtitle: @admin_news.subtitle, title: @admin_news.title, user_id: @admin_news.user_id } }
    end
  ...
  test "should update admin_news" do
    patch admin_news_url(@admin_news), params: { admin_news: { content: @admin_news.content, subtitle: @admin_news.subtitle, title: @admin_news.title, user_id: @admin_news.user_id } }
