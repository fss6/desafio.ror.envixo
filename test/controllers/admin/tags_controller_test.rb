...
class Admin::TagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_tag" do
    assert_difference('Admin::Tag.count') do
      post admin_tags_url, params: { admin_tag: { locale: @admin_tag.locale, name: @admin_tag.name, user_id: @admin_tag.user_id } }
    end
  ...
  test "should update admin_tag" do
    patch admin_tag_url(@admin_tag), params: { admin_tag: { locale: @admin_tag.locale, name: @admin_tag.name, user_id: @admin_tag.user_id } }
